## [ZENCash](https://zensystem.io/) Desktop GUI Wallet binary release 0.84.1 for Mac OS Sierra/High Sierra

This is a [ZENCash](https://zensystem.io/) Desktop GUI Wallet binary release 0.84.1 for Mac OS. 
It includes [ZENCash 2.0.15 binaries](https://github.com/HorizenOfficial/zen/releases/tag/v2.0.15).
...
[ZENCashWallet-0.84.1.dmg](https://github.com/HorizenOfficial/zencash-swing-wallet-ui/releases/download/0.84.1/ZENCashWallet-0.84.1.dmg). 
