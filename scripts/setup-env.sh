...
export COMMON_PARAMS="--java-options -Xmx1536m --verbose --license-file ./LICENSE --copyright \"Copyright (c) 2020 Zen Blockchain Foundation\" --description \"Horizen Desktop GUI Wallet ${VERSION}\""
